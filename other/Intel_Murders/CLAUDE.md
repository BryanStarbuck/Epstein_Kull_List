...
This project is separate from the Epstein Kill List (two directories up at `../../README.md`), which focuses on deaths connected to Jeffrey Epstein's sex-trafficking and blackmail operation. This project focuses on **intelligence service killings** — assassinations carried out by or connected to CIA, MI6, Mossad, KGB/FSB, GRU, DINA, ISI, Saudi GIP, and other intelligence services worldwide.

## Charter

The core question: **Which deaths since 1969 bear the hallmarks of intelligence service operations — and what do they reveal about how intelligence agencies control, silence, and eliminate people?**
...
* **Types of killings:**
  * Political assassinations of foreign leaders
  * Assassinations of dissidents, defectors, and exiles
  * Killings of journalists investigating intelligence operations
  * Deaths of whistleblowers who exposed intelligence crimes
  * Deaths of scientists and weapons researchers
  * "Friendly fire" cover-ups with intelligence dimensions
  * Domestic activists killed by intelligence/law enforcement (COINTELPRO, etc.)
  * Proxy assassinations (intelligence services using criminal organizations, cartels, or terrorist groups)
* **Geographic focus:** Worldwide, with special attention to operations targeting Americans or conducted on American soil
* **What stays in the Epstein repo:** Deaths connected primarily to sex-trafficking blackmail operations remain in `../../README.md`. Some overlap exists (e.g., Danny Casolaro investigated both PROMIS/intelligence and the Epstein orbit) — cross-link where appropriate.

## Focus Areas

* CIA assassinations and covert operations (post-Church Commission)
* Russian intelligence murders (KGB/FSB/GRU poisonings, defector killings)
* Mossad targeted killings
* NATO stay-behind / Operation Gladio killings
* Journalist and whistleblower deaths with intelligence connections
* Scientists and weapons inspectors killed before testimony
* Political figures assassinated to control governments
* COINTELPRO and domestic intelligence killings
* Proxy wars and intelligence-directed assassinations
...
* `README.md` — Main entry point; the master table of all people with one-line summaries, organized by category
...
* **Dissident / Defector** — Person who left or opposed an intelligence service or authoritarian regime
* **Journalist / Investigator** — Researched or reported on intelligence operations
* **Whistleblower** — Exposed intelligence crimes from the inside
...
* **Military / Law Enforcement** — Killed under suspicious circumstances with intelligence dimensions
* **Banker / Financier** — Handled intelligence money flows
* **Diplomat** — Killed in connection with intelligence operations
* **Political Figure** — Politicians targeted to control governments
...
* Cross-link to Epstein Kill List profiles where overlap exists (use `../../Details/Name.md`)
...
## Cross-Linking with Epstein Kill List

Some individuals appear in both projects:
...
When a person has a profile in both projects, link between them. Use `../../Details/Name.md` for Epstein Kill List profiles.
