# Suppressed Energy Breakthroughs — Project Instructions
...
- UAP/UFO deaths with **no energy technology connection** — those go in `../UAPs/`
- Epstein network deaths — those go in the main `../../Details/` directory
- Intelligence service political assassinations with **no energy angle** — those go in `../Intel_Murders/`
...
```
Zero_Point_Energy/
├── README.md          # Master table: all energy suppression deaths, events, and at-risk persons
...
- **No non-person files** in `Details/`. Research notes, physics articles, essays, and other content go elsewhere (e.g., `Details/pte_physics.md` is an exception established by the project owner for the foundational physics article).
...
Every person gets a full profile in `Details/`. The template varies slightly based on whether the person is deceased, living/suppressed, disappeared, or institutionalized.

### Template A: Deceased Person

```markdown
[< Back to Energy Suppression List](../README.md) | [Main Epstein List](../../../README.md)
...
- [Person in Sibling Directory](../UAPs/Details/Person.md) — Cross-project link
...
- **Details → README**: Every profile has a back-link header: `[< Back to Energy Suppression List](../README.md)`
...
- **To UAPs**: `[Person Name](../UAPs/Details/Person_Name.md)`
...
Other directories should link back to energy suppression profiles when relevant. If a person appears in multiple directories (e.g., a Marconi scientist appears in both UAPs and Zero Point Energy), both profiles should link to each other.
...
- **Stanley Meyer** — appears in both Zero Point Energy and UAPs (water fuel cell, suppressed technology)
- **Marconi scientists** — may appear in both Zero Point Energy and UAPs (SDI "Star Wars" connection)
- **Nikola Tesla** — could appear in Zero Point Energy and UAPs (energy research, alleged government seizure)
...
| **UAPs** | Deaths/silencing connected to UAP/UFO information | `../UAPs/` |
| **Zero Point Energy** (this directory) | Advanced energy inventors/researchers killed or suppressed | `./` |
| **Groups** | Organizations, intelligence services, and operations | `../groups/` |

### Overlap Rules

People can appear in multiple directories when they fit multiple scopes:
- **Stanley Meyer** — appears in both Zero Point Energy and UAPs (water fuel cell, alleged UAP connection)
- **Marconi scientists** — may appear in both Zero Point Energy and UAPs (SDI-connected defense work)
- **Nikola Tesla** — appears in Zero Point Energy (energy research) and potentially UAPs (government seizure, alleged exotic technology)
