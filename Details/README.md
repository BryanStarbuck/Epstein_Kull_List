...
Each person listed below has an individual detail file containing their full background, the circumstances of their death, their connection to the Epstein case, a suspicion assessment (ranging from "Not suspicious" to "Highly suspicious"), and the reasons why their death has been questioned by the public or investigators.
...
### Primary Databases
- **epstein_deaths_comprehensive.yaml** — Main database with 23 documented individuals, full details, sources, and metadata
- **epstein_deaths_expanded_details.yaml** — Expanded version with in-depth research details for 10 individuals
- **epstein_deaths.yaml** — Original database with structured entries
...
| Statistic | Count |
|-----------|-------|
| Total Documented Deaths | 23 named + 2 alleged unnamed |
...
| Homicide (physician-caused, unrelated) | 1 |
| Unsolved murder | 1 |
| Unknown | 2 |
| Unverified claim | 2 |
...
| Witnesses | 1 |
| Primary Subject | 1 |
| Alleged/Unverified | 1 (representing 2 individuals) |

## Research Methodology

Research was conducted on February 7, 2026 through:
